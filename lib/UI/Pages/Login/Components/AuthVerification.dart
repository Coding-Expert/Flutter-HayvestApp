...
class AuthVerification extends StatefulWidget {
  ...
  @override
  _AuthVerificationState createState() => new _AuthVerificationState();
}

class _AuthVerificationState extends State<AuthVerification> with SingleTickerProviderStateMixin {
  // Constants
  final int time = 30;
